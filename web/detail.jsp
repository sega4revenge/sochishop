<%-- 
    Document   : detail
    Created on : Jun 22, 2017, 3:51:19 PM
    Author     : Duong
--%>
    ...
    <body>
      <% 
            ...
            if(request.getParameter("productID") !=null){
                ...
                product = productDAO.getProduct(Long.parseLong(product_id));
            }
        %>
                                ...
                                <div class="products-details">
                                    <div class="preview_image">
                                        <!--<div class="preview-small">-->
                                            <img id="zoom_01" src="images/products/medium/products-01.jpg" data-zoom-image="images/products/large/products-01.jpg" alt="#"/>
                                        </div>
                                    <!--hinh mini-->
